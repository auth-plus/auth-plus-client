<script lang="ts">
	...
	type Props = {
		...
		setAction: (strategy: Strategy, mfaId: string) => void
	}
	let { alreadySetup, setAction, strategy }: Props = $props()
...
<button onclick={createNewStrategy} class:alreadySetup style="background-image: url({getImage()})">
